...
/*
    NOTA: EL PROCESO DE MD5 SE REALIZÓ SE REALIZÓ A PARTIR DE GEMINI
    SE TIENE UNA COMPRENSIÓN DEL FUNCIONAMIENTO, PERO EL CÓDIGO NO
    FUE HECHO POR MÍ. SE AÑADIÓ CON TAL DE QUE EL ROUTER SE ACERCARA
    LO MÁS POSIBLE A SU FUNCIONAMIENTO REAL
*/
