...
void MD5::transform(const uint1 block[64]) {
  ...
  HH (a, b, c, d, x[ 5], S31, 0xff447b8); HH (d, a, b, c, x[ 8], S32, 0xcee1e796);
  HH (c, d, a, b, x[11], S33, 0x4787c62a); HH (b, c, d, a, x[14], S34, 0xdf1211c1);
  HH (a, b, c, d, x[ 1], S31, 0x33883472); HH (d, a, b, c, x[ 4], S32, 0xebe1266b);
  HH (c, d, a, b, x[ 7], S33, 0xdef314af); HH (b, c, d, a, x[10], S34, 0x45812f17);
  HH (a, b, c, d, x[13], S31, 0x61c24414); HH (d, a, b, c, x[ 0], S32, 0xab9423a7);
  HH (c, d, a, b, x[ 3], S33, 0xf950171f); HH (b, c, d, a, x[ 6], S34, 0x12835b01);
  HH (a, b, c, d, x[ 9], S31, 0xd440131c); HH (d, a, b, c, x[12], S32, 0x277172c7);
  HH (c, d, a, b, x[15], S33, 0xfe2ce6e0); HH (b, c, d, a, x[ 2], S34, 0xa301fbc1);
  ...
  II (c, d, a, b, x[ 6], S43, 0xa301fbc1); II (b, c, d, a, x[13], S44, 0x4e0811a1);
